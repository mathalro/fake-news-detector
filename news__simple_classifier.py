"""
	This program is a classifier for sentences. Given a dataset of sentences, 
	the program trains a neural network to say if the sentence is a good or a bad feedback.
"""
